...
class _VerificationCodeScreen2State extends State<VerificationCodeScreen2> {
  ...
  void initState() {
    super.initState();
    // إرسال رمز التحقق عند فتح الشاشة
                  ...
                  Positioned(
                    ...
                    child: Column(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => _sendOtp(), // إعادة إرسال الرمز
                          child: const Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(
  ...
  void _verifyOtp(BuildContext context, AuthProvider authProvider) async {
    ...
    // إذا كان الرمز صحيحاً، انتقل إلى شاشة استكمال البيانات
    if (success && context.mounted) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => CompleteDataScreen(email: widget.email),
        ),
      );
    }
  }
