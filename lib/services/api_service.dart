...
class ApiService {
  ...
  Future<Response> completeRegister(Map<String, dynamic> data) async {
    try {
      final response = await _dio.post('$baseUrl/complete/register', data: data);
      return response;
    } catch (e) {
  ...
  Future<Response> sendOtp(String email) async {
    try {
      final response = await _dio.get('$baseUrl/send/otp',
  ...
  Future<Response> checkOtp(String email, String otp) async {
    try {
      final response = await _dio.get('$baseUrl/check/otp',
